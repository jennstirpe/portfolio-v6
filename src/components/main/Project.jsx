  ...
  return (
    <StyledProject >
        <div className="project-card" style={{"backgroundImage": `url(${project.img})`}}>
            <button onClick={() => setDetailsActive(!detailsActive)} className="mobile-toggle-details" aria-label="Toggle more info">
                {
                    detailsActive ? (
...

            {
                detailsActive ? (
                    <div className="mobile-project-details">
                        ...
                        <button className="project-modal-btn">Description</button>
                        ...
                        <div className="project-links">
                            ...
                            <a className="project-link" href={project.link} aria-label="Live site"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-external-link"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg></a>
                        </div>
                    </div>
                ) : null
            }
            ...
            <div className="desktop-project-details">
                <h4 className="project-name">{project.name}</h4>
                <button className="project-modal-btn">More Info</button>
